...
export default function Main(){
    ...
    return(
        ...
        <div>
                ...
                Welcome To{' '}
                <span style={{color: 'mediumblue', backgroundColor: 'orangered '}}>De</span>
                <span style={{color: 'black', font: 'bold'}}>Net</span>{' '}
                !
                </h1>
            ...
            className="inline-flex h-8 w-40 justify-center font-bold text-white"
            onClick={() => {
                //Go to Profile
                GotoProfile();
            }}
            ...
            <div className="flex flex-col py-24 place-items-center justify-center">
                            ...
                            <a href={explorerLink}>
                                <h1 className="text-md font-bold text-black-500">
                                    {explorerLink}
                                </h1>
                            </a>
                            <br />
